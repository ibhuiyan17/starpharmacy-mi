...
const NAV = [
  ...
  { href: "#about", label: "What We Offer" },
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a href={`tel:${site.phone}`} className="btn-brand !px-4 !py-2 text-sm">
      ...
      {open && (
        <nav className="lg:hidden border-t border-border bg-white/95 backdrop-blur-md">
          <div className="mx-auto max-w-6xl px-4 py-3 flex flex-col">
            ...
            {status && (
              <span className="mt-2 text-sm text-text-muted">{status.message}</span>
            )}
          </div>
        </nav>
      )}
